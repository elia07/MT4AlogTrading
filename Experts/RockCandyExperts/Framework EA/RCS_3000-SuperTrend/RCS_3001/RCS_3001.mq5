...
//
CIndicatorSUPERTREND	*SupertrendIndicator;
...
int OnInit() {
	...
	//
	SupertrendIndicator	=	new CIndicatorSUPERTREND(InpPeriod,InpMultiplier,InpFill);
   ...
   //3 Color
	...
	EntrySignal.AddIndicator(SupertrendIndicator, 3);
