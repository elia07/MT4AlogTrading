...
input	double	InpUpperExitLimit   						=	10;
input	double	InpLowerExitLimit   						=	-10;
input	double	InptCrossThreshold   					=	10;
...
//
//	TPSL
//TODO : Must Change to proper StopLoss
CTPSLSuperTrendHeikenAshiJustStopLoss	*TPSL;
...
int OnInit() {
   ...
   TsiIndicator4H = new CIndicatorTSI(Symbol(),PERIOD_D1,InpTSIR,InpTSIS,InpTSISP);
	...
	//Buffers
   //3 Color
	EntrySignal	=	new CSignal_RCS40001(1,2,InpUpperLimit,InpLowerLimit);
	...
	EntrySignal.AddIndicator(TsiIndicator4H,0);
	EntrySignal.AddIndicator(TsiIndicator4H,1);
	EntrySignal.AddIndicator(HeikenAshiIndicator,4);
